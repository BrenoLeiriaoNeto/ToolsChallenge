...
public interface IPagamentoService {
    ...
    PagamentoViewModel estornarPagamento(String transacaoId);
    PagamentoViewModel consultaEstorno(String transacaoId);
    PagamentoViewModel consulta(String transacaoId);
